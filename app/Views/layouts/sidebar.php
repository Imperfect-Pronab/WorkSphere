...
<aside class="sidebar">
    ...
    <nav style="flex:1;padding:12px;overflow-y:auto;">
        ...
        <?php if ($role === 'super_admin') : ?>
            ...
            <a href="<?= base_url('admin/dashboard') ?>" class="sb-nav-item active">
            ...
            <a href="<?= base_url('admin/employees') ?>" class="sb-nav-item">
                <svg class="sb-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?= base_url('admin/departments') ?>" class="sb-nav-item">
                <svg class="sb-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?= base_url('admin/settings') ?>" class="sb-nav-item">
                <svg class="sb-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?= base_url('admin/reports') ?>" class="sb-nav-item">
                <svg class="sb-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
