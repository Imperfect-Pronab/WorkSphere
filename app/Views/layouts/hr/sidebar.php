...
<aside class="sidebar">
    ...
    <nav style="flex:1;padding:12px;overflow-y:auto;">
        ...
        <a href="<?= base_url('hr/dashboard') ?>" class="sb-nav-item <?= isActive('hr/dashboard') ?>">
        ...
        <a href="<?= base_url('hr/attendance') ?>" class="sb-nav-item <?= isActive('hr/attendance') ?>">
            <svg class="sb-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?= base_url('hr/employees') ?>" class="sb-nav-item <?= isActive('hr/employees') ?>">
            <svg class="sb-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?= base_url('hr/leaves') ?>" class="sb-nav-item <?= isActive('hr/leaves') ?>">
            <svg class="sb-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
